...
public class ShowCastAdapter extends RecyclerView.Adapter<ShowCastAdapter.CastViewHolder> {

    private Context context;
    private List<ShowCastsForPerson> list;

    public ShowCastAdapter(Context context, List<ShowCastsForPerson> list){
