...
public class PersonMovieAdapter extends RecyclerView.Adapter<PersonMovieAdapter.PersonViewHolder> {

    public interface OnItemClickListener {
        void onClick(MovieCastsForPerson movieCastsForPerson);
    }

    private List<MovieCastsForPerson> movieCastsForPersonList = new ArrayList<>();
    private OnItemClickListener onItemClickListener;
    private Context context;

    public PersonMovieAdapter(OnItemClickListener onItemClickListener, Context context) {
        this.onItemClickListener = onItemClickListener;
        this.context = context;
    }

    public void add(List<MovieCastsForPerson> movieCastsForPeople) {
    ...
    public void onBindViewHolder(@NonNull PersonViewHolder holder, int position) {
        MovieCastsForPerson movieCastsForPerson = movieCastsForPersonList.get(position);
        ...
        holder.title.setText(movieCastsForPerson.getOriginalTitle());
