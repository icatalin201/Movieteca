...
public class FullMovieListActivity extends AppCompatActivity implements PreviewMovieAdapter.OnItemClickedListener {
    ...
    private FullMovieListViewModel fullMovieListViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullMovieListViewModel = ViewModelProviders.of(this).get(FullMovieListViewModel.class);
        fullMovieListViewModel.start(type, presentPage, "US");
        ...
        fullMovieListViewModel.getData().observe(this, previewMovies -> {
            previewMovieAdapter.add(previewMovies);
            presentPage++;
        });
        fullMovieListViewModel.getIsLoading().observe(this, isLoading -> {
            if (isLoading) {
